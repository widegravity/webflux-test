...
final class BoundedElasticScheduler
    ...
    public Disposable schedule(Runnable task) {
        ...
        System.out.println("BoundedElastic schedule : " + cached);
        if (cached != null) {
            ...
            System.out.println("offer to deferredFacades : " + deferredDirect);
...
//                }
        ...
        public void dispose() {
            if (exec != null) {
                if (this != SHUTDOWN && !parent.shutdown) {
                    ...
                    System.out.println("Polled DeferredFacade : " + deferredFacade);
    ...
    static final class DeferredWorker extends ConcurrentLinkedQueue<DeferredWorkerTask> implements Worker, Scannable,
        ...
        public void dispose() {
            if (DISPOSED.compareAndSet(this, 0, 1)) {
                System.out.println(parent.deferredFacades.size());
    ...
    static final class DeferredDirect extends AtomicReference<CachedService> implements Scannable, Disposable,
        ...
        public static AtomicIntegerFieldUpdater<DeferredDirect> getDISPOSED() {
            return DISPOSED;
        }
